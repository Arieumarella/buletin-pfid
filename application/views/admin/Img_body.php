                    ...
                    <?php $no=1; foreach ($dataPicture as $key ) { ?>
                      <tr>
                        ...
                        <td>
                          ...
                          <img src="<?= base_url(); ?>assets/list_picture/<?= $key->name; ?>">
    ...
    <div class="modal-dialog">
      <div class="modal-content bg-info">
        ...
        <div class="modal-body bg-light">
          <form id='formPict' action="<?= base_url(); ?>Admin/ImageBody/save" method="post" enctype='multipart/form-data'>
            ...
            <div class="form-group">
              ...
              <div class="custom-file">
                ...
                <p style="color: #dd2c00; font-size: 13px;">*Gambar Harus Berukuran 1120x1560 pixels.</p>
    ...
    $( document ).ready(function() {
      ...
      hapusData = async function (id) {
        ...
        if(choice === true) {
          ...
          $.ajax({
            url: base_url()+'admin/ImageBody/hapus',
            type: "post",
